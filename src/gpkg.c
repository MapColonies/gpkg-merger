...
void mergeGpkgsNoThreads(Gpkg *baseGpkg, Gpkg *newGpkg, int batchSize)
{
    ...
    for (int i = 0; i < amount; i++)
    {
        ...
        // TODO: mergeTileBatch(tileBatch, baseTileBatch, baseDb, baseGpkg->tileCache);
